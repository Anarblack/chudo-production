...
const projectVideos = {
  adidas: makeDriveVideos([
    ['1VHPK5R_tjqYV61yBrvn1L1Go6pLLLwW1', 'Brand film'],
    ['1DfLaZxEqBkjDvxs2eldOzwjWTIkitRUJ', 'Short cut'],
    ['1IkDde365JsdioIaCFuoe8LpUcQB_jBLc', 'Lifestyle'],
  ]),
  alatoo: makeDriveVideos([
    ['1J_1bCDrQHQPgla-EsAMPz_wslnR8W1Cu', 'Image video'],
    ['1JcK83IHsCvLwwac8JYhHqL3eTcFWMyyn', 'Social cut 1'],
    ['1a4ohYEt_bI-UIcBfJWx3pR9MV1AYHE88', 'Social cut 2'],
    ['1uEua-LEuB9jQ73kF2FNL_HLk_ypV4tHd', 'Promo'],
  ]),
  asab: makeDriveVideos([
    ['17liSyYVtImTeRojjEnUOURA30gm9yJo2', 'Commercial'],
  ]),
  asylsu: makeDriveVideos([
    ['16g90albOpWyllqvlOHUBru6sKe9sOcDm', 'Product video'],
  ]),
  avangard: makeDriveVideos([
    ['1ASTGu7_Q28dHthkKEsg_B21PrX49W2iU', 'Главный ролик'],
    ['1ASwYfsCnRHpdcYwQho8hs62GU9Yxma2T', 'Версия для продаж'],
    ['1HghZ06c22ZiKHSJcaYfg9Y4EKJklzSBt', 'Social cut 1'],
    ['19qootdkvuQkGaYzLSqQ5fN_pVjTAgCZu', 'Social cut 2'],
  ]),
  aviasales: makeDriveVideos([
    ['1pSVcpygr3FpGd9JWu6pgRuBEGI7itork', 'Digital video'],
    ['147RmNkWmHdmEnXn-dy_amcwtrNkg3A3y', 'Shorts'],
  ]),
  chevrolet: makeDriveVideos([
    ['1izhQXJhOHNYUylhEw6gvSAh4q_2Lsild', 'Hero video'],
    ['1iaWus22Vv9su1yIpDWuFDvhc3FYZkKLz', 'Версия 2'],
    ['1b98iRV-n-wRzjkthPjeKJnpmomAfefX5', 'Версия 3'],
    ['1DyaJaYK2nN0WmD0bu65wJuQgcddy6C9V', 'Версия 4'],
    ['1QKp9mrvVC80x3J_eWuNa6W3u0zvw_GLD', 'Social cut 1'],
    ['1DO3mGYA6Zp6qlVSurher-mJJKPGVQYOT', 'Social cut 2'],
    ['1uWBA7OHcG6Wpv_w8d9TD9p6PCLPCFCGQ', 'Social cut 3'],
    ['1C9TmQGkuvBOE9reJaLjcms3RmEJas_je', 'Social cut 4'],
  ...
  contentPack: makeDriveVideos([
    ['1mBZISGnU1RpH7j1KBImQPd-JMC2rK94p', 'Ролик 1'],
    ['1LX7SSZjsT4xFC3IV4MlZtHkvaYhzUNi4', 'Ролик 2'],
  ]),
  kia: makeDriveVideos([
    ['1b4AuFxVdcNEn9yOxKauANt1of7vuZ6gY', 'Model video'],
    ['1hyzszKbngFvWVngtPB9Hg984tOMuf4Ax', 'Reels 1'],
    ['1aIUl5Y0rtFvb2_VZjmXAT0T11el693kQ', 'Reels 2'],
    ['1qXz7AyltiXHsGwd4LG_IPiNgji0itmLc', 'Shorts 1'],
    ['1QW0b7zr9L83J5DGVCg4hPBVyLfk0JNXh', 'Shorts 2'],
  ]),
  letsgo: makeDriveVideos([
    ['1fW0DlF9QWwOUbzDSGn4HGdanyx6IaQKb', 'Promo'],
  ]),
  mrbbq: makeDriveVideos([
    ['1ZahuAYFgQX-aRFCBaOrXHNN6Ds5oVvwb', 'Food video'],
  ]),
  ngroup: makeDriveVideos([
    ['1l8JtkgvnBxqsIAHod1wYMBNai8LBui9e', 'Presentation video'],
    ['1MIXKTTJupViDYPzcdzNDU9OZEhLStJZH', 'Версия 2'],
    ['1lcc1b6Z1UdjQqE66XmrECwkbkSajHqEt', 'Sales cut'],
    ['1O5xtQ-H4OkbDh8qdPPCHqQ8m-AipdhD8', 'AI 1'],
  ]),
  roxy: makeDriveVideos([
    ['1PeEoxijPSQBizFImlHV1nLNdnCGaofWv', 'Brand film'],
    ['10WqjceGrWR-wAsjUKVjh1j2g9hiuydo6', 'Reels'],
    ['1cL4yco8aIwuHqS7CT0xPa3mkczE8bVXZ', 'Short cut'],
  ]),
  vibe: makeDriveVideos([
    ['1bI4fWsdOUi65WPyGiy9mSr7EAS8GbQpY', 'Brand film'],
    ['1fvYuc3dr4pIRaTBQcTZmMwDHMDPlSSgG', 'Social cut'],
  ]),
  ...
  xcomp: makeDriveVideos([
    ['1AfFereLiQuP4Ja85FHW9E9rpe1kxZXdj', 'B2B video'],
  ]),
  expert: makeDriveVideos([
    ['1CvBIa_mHLXesQWD0OpNV_VxppEohCtf-', 'Ролик 1'],
    ['13XV_IjQRzg5oTvMapqtwumstce6QQ1-c', 'Ролик 2'],
    ['1LaPz_qc1uuN631QqPIDYRSQ1CDQXh57x', 'Ролик 3'],
    ['13UVr_Qmm5O_vEPQk5pX0QcJg9q0TyA66', 'Ролик 4'],
    ['1f_mp1D-9aopG9crZFqBmQQkR5Weq33rs', 'Ролик 5'],
    ['1jvUDkj7F0U7tkRJbtjNI1Ch7AFjYagTA', 'Ролик 6'],
  ]),
  ...
  upsm: makeDriveVideos([
    ['1Ryrd3NxRyyOctihArlHIcLd5vRLGwJO-', 'Presentation'],
  ]),
  product: makeDriveVideos([
    ['1vgKug9XElsmd5mzmgvQcXrdsdBeY4Ird', 'ЦУМ GOLD'],
  ]),
  shtuchki: makeDriveVideos([
    ['1Mg_HDqw1VGxPlQEw4Hlio-rX8tZ7ZEwE', 'Product video'],
    ['1LcLy_jlcP0nOf0cGSjG8DvGaClSZ6h37', 'Reels'],
  ]),
};
