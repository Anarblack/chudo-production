  ...
  useEffect(() => {
    ...
    if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
      ...
      stepsRef.current.forEach((el, i) =>
        el?.style.setProperty('--step-lit', STEP_POS[i] === 0.5 ? '1' : '0.35'));
      return;
    }
    ...
    function tick() {
      if (!hasPointer) {
        autoT   += 0.005;
        targetP  = 0.5 + 0.42 * Math.sin(autoT);
      }
      currentP = lerp(currentP, targetP, 0.065);
  ...
  return (
    <div ref={containerRef} className="ct-process" aria-hidden="true">
      ...
      <div className="ct-process__line-wrap">
        ...
        <div className="ct-process__line-glow" />
